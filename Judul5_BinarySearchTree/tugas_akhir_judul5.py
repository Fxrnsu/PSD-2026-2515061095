...
def main():
    ...
    while True:
        ...
        print("2. Cari Ketersediaan Kode Buku")
        print("3. Cek Kode Buku Terkecil")
        print("4. Cek Kode Buku Terbesar")
        print("5. Tambah Kode Buku Baru")
        ...
        if pilihan == 1:
            ...
            print(f"Kode terkecil di perpustakaan: {bst.find_min(bst.root)}")
            
        elif pilihan == 4:
            print(f"Kode terbesar di perpustakaan: {bst.find_max(bst.root)}")
